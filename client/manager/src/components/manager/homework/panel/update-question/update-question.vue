  ...
  <section class="update-question">
    <div class="question-header">
      <p class="header-title">
        <span class="title-main">修改问题</span>
        <span class="title-tip">（问题编号 {{qid}}）</span>
      </p>
    ...
    <div class="question-operation">
      <ul class="operation-setting-list">
        ...
        <li class="list-item">
          <label class="item-label" for="question-setting-update-index">顺序：</label>
          <select class="item-select" id="question-setting-update-index" v-model="index">
...
export default {
  name: 'QuestionUpdateQuestionPanelComponent',
  data () {
    return {
      qid: 0,
      gametype: 0,
